...
export const practiceSheets: PracticeSheet[] = [
  ...
  },
  {
    ...
    stage: 3,
    summary:
      "練習可讀嘅 modern 大寫骨架；練習紙唔再印橢圓主環與細尾卷鬚，花飾留待手寫時再加。",
    level: "第 3 級",
    tools: "尖筆、墨水",
    uses: ["大寫骨架", "可讀優先", "花飾預備"],
    guidance: [
  ...
  },
  {
    ...
    kind: "flourish-words",
    stage: 4,
    summary: "以 modern script 寫詞，練節奏與字距；練習紙唔再印左右卷鬚花飾。",
    level: "第 4 級",
    tools: "尖筆、墨水",
    uses: ["整詞節奏", "字距", "作品應用"],
    guidance: [
      "先寫清楚現代花體詞。",
      "練習紙只留字形；花飾如要加，自己手寫時再加一處即可。",
      "整詞完成後退後審視字距與彈跳節奏。",
    ],
    sheetTip: "只練字形與字距；唔印左右卷鬚。",
