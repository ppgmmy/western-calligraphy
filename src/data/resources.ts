...
export const practiceTracks: Array<{
  ...
  },
  {
    ...
    summary: "尖筆：導引線 → 橢圓 → 基本筆畫 → Copperplate Capitals → 核心小寫 → 短詞。",
    tools: "尖筆、墨水",
    sheetSlugs: [
...
export const practiceSheets: PracticeSheet[] = [
  ...
  {
    slug: "copperplate-capitals",
    titleZh: "銅板體大寫｜Copperplate Capitals",
    titleEn: "Copperplate Capitals",
    styleId: "copperplate",
    kind: "alphabet-upper",
    stage: 1,
    track: "copperplate",
  ...
  },
  {
    ...
    stage: 1,
    summary:
      "以當代 modern calligraphy 範字練習 a–z：略帶彈跳、粗細自然，作為花飾前的字體底子。",
    level: "第 1 級",
    tools: "尖筆、墨水",
    uses: ["現代花體", "小寫骨架", "花飾前打底"],
    guidance: [
      "先求可讀與一致斜度，再追求飄逸。",
      "下行稍加力、上行輕提，模仿尖筆粗細。",
      "字母之間可有輕微高低差，但基線感覺仍要統一。",
    ],
    sheetTip: "Modern script 小寫：優雅、可讀，再進入花飾。",
    track: "flourishing",
  },
  {
