  ...
  strokes: [
    {
      ...
      points: [
      { x: 12, y: 40, r: 0.55 },
      { x: 14.68, y: 43.83, r: 0.7 },
      { x: 17.37, y: 47.67, r: 0.85 },
      { x: 20.05, y: 51.5, r: 1 },
      { x: 22.73, y: 55.33, r: 1.15 },
      { x: 25.42, y: 59.17, r: 1.3 },
      { x: 28.1, y: 63, r: 1.45 },
      { x: 30.78, y: 66.83, r: 1.6 },
      { x: 33.47, y: 70.67, r: 1.75 },
      { x: 36.15, y: 74.5, r: 1.9 },
      { x: 38.83, y: 78.33, r: 2.05 },
      { x: 41.52, y: 82.17, r: 2.2 },
      { x: 44.2, y: 86, r: 2.35 },
