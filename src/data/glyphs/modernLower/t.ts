  ...
  strokes: [
    {
      ...
      points: [
      { x: 12, y: 26, r: 0.55 },
      { x: 14.22, y: 29.17, r: 0.7 },
      { x: 16.43, y: 32.33, r: 0.85 },
      { x: 18.65, y: 35.5, r: 1 },
      { x: 20.87, y: 38.67, r: 1.15 },
      { x: 23.08, y: 41.83, r: 1.3 },
      { x: 25.3, y: 45, r: 1.45 },
      { x: 27.52, y: 48.17, r: 1.6 },
      { x: 29.73, y: 51.33, r: 1.75 },
      { x: 31.95, y: 54.5, r: 1.9 },
      { x: 34.17, y: 57.67, r: 2.05 },
      { x: 36.38, y: 60.83, r: 2.2 },
      { x: 38.6, y: 64, r: 2.35 },
