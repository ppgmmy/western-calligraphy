  ...
  strokes: [
    {
      ...
      points: [
      { x: 8, y: 40, r: 0.55 },
      { x: 6.32, y: 42.4, r: 0.73 },
      { x: 4.64, y: 44.8, r: 0.91 },
      { x: 2.96, y: 47.2, r: 1.09 },
      { x: 1.28, y: 49.6, r: 1.27 },
      { x: -0.4, y: 52, r: 1.45 },
      { x: -2.08, y: 54.4, r: 1.63 },
      { x: -3.76, y: 56.8, r: 1.81 },
      { x: -5.44, y: 59.2, r: 1.99 },
      { x: -7.12, y: 61.6, r: 2.17 },
      { x: -8.8, y: 64, r: 2.35 },
      { x: 24.8, y: 64, r: 2.35 },
